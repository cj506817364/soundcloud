...
<script type="text/javascript"
	src="${scp}/backend/assets/js/WdatePicker.js"></script>
	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<form action="" method="post"  >
				<div class="admin">
					<div class="xinxitj" style="font-weight: blod; font-size: 30px;">信息概况</div>
					<hr />
					<span> <a href="#"
						onclick="formSubmit('save','_self');this.blur();">保存</a>&nbsp;&nbsp;
					...
					<table class="am-table">
						...
						<tr>
							<td>作词:</td>
							<td><input type="text" name="writeWords" /></td>
							<td>作曲:</td>
							<td><input type="text" name="compose" /></td>
						</tr>
						<tr>
							<td>播放次数:</td>
							<td><input type="text" name="playNum" /></td>
							<td>状态:</td>
							<td><input type="radio" name="state" value="1" />启用 <input
								type="radio" name="state" value="0" />禁用</td>
						</tr>
