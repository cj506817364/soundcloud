...
<link rel="stylesheet"
	href="${scp}/js/jvectormap/jquery-jvectormap-1.2.2.css" type="text/css" />
<!--  [if lt IE 9]>
...
<body class="">
				...
				<section id="content">
					<section class="vbox">
						<section class="scrollable wrapper">
							<div class="panel b-a">
								<div class="panel-heading b-b">chart</div>
								<div class="panel-body">
									<div class="h3 m-b font-thin">City chart with information</div>
									
									<div class="row">
										<div class="col-sm-8">
											<div class="row" id="main" style="height: 400px;"></div>
										...
										<div class="col-sm-4">
											<div class="h4 m-b font-thin">注册人数占比</div>
											<p class="m-b-xs">武汉注册人数占比</p>
											<div class="progress progress-xs">
												<div class="progress-bar bg-primary" data-toggle="tooltip"
													data-original-title="${wuhanAll}%" style="width: ${wuhanAll}%"></div>
											</div>
											<p class="m-b-xs">北京注册人数占比</p>
											<div class="progress progress-xs">
												<div class="progress-bar bg-success" data-toggle="tooltip"
													data-original-title="${beijinAll}%" style="width: ${beijinAll}%"></div>
											</div>
											<p class="m-b-xs">女性注册人数占比</p>
											<div class="progress progress-xs">
												<div class="progress-bar bg-warning" data-toggle="tooltip"
													data-original-title="${womanAll}%" style="width: ${womanAll}%"></div>
											</div>
											<p class="m-b-xs">男性注册人数占比</p>
											<div class="progress progress-xs">
												<div class="progress-bar bg-dark lter" data-toggle="tooltip"
													data-original-title="${manAll}%" style="width: ${manAll}%"></div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="panel b-a">
								...
								<div class="panel-body">
									...
									<p class="m-b-lg text-muted">
										由于数据量限制,使得注册人数较少,无法完全展现map的特效;
												这里采用上表中显示的实际注册人数扩大30倍来显示 --by ppj
									</p>
									<div class="row m-b-xl">
										<div class="col-sm-8">
											<div id="friend_map" style="height: 400px;"></div>
											<div class="m-t-xl m-b clearfix">
												<i class="i i-local i-2x text-info pull-left m-r m-l m-t-xs"></i>
												<div class="clear text-sm"></div>
											</div>
											<!-- 	<div id="usa_map" style="height: 240px;"></div> -->
										</div>
										<div class="col-sm-4">
											...
											<div>
												<div class="inline text-center">
													<div class="easypiechart" data-percent="60"
														data-bar-color="#fcc633" data-line-width="4"
														data-loop="false" data-scale-color="#fff" data-rotate="0"
														data-size="100">
														<div>
												...
												<div class="inline text-center">
													<div class="easypiechart" data-percent="35"
														data-bar-color="#177bbb" data-line-width="4"
														data-loop="false" data-scale-color="#fff" data-rotate="0"
														data-size="100">
														<div>
	...
	<script src="${scp}/js/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="${scp}/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<script src="${scp}/js/jvectormap/jquery-jvectormap-us-aea-en.js"></script>
	<script src="${scp}/js/jvectormap/demo.js"></script>
	...
	<!-- 引入 echarts.js -->
	<script src="${scp}/js/echarts/echarts.js"></script>
	<script type="text/javascript">
		$(function() {
			var nums = ${num};
			var citys = ${city};
	...
	<script type="text/javascript">
		var mapJsons = ${mapJson}
		// 基于准备好的dom，初始化echarts实例
		//var myChart = echarts.init(document.getElementById('main'));
		$.get('${scp}/js/echarts/china.json', function(chinaJson) {
			echarts.registerMap('china', chinaJson);
			var chart = echarts.init(document.getElementById('friend_map'));
