							...
							<div class="panel b-a">
								...
								<div class="panel-body">
									...
									<p class="m-b-lg text-muted">
										由于好友数据量限制,使得注册人数较少,无法完全展现map的特效;
												这里采用上表中显示的实际注册人数扩大100倍来显示 --by ppj
									</p>
