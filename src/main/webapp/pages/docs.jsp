    ...
    <section id="content">
      <section class="vbox">
        <section class="scrollable bg-light lter" data-spy="scroll" data-target=".nav-primary">
          <section  id="docs">
            <div class="clearfix padder">
              ...
              <h4 id="icons" class="m-t-lg">图标</h4>
        ...
        <i class="icon-reorder"></i>
              ...
              <h3 class="text-info">部件 <small>Lightweight components to best practice on mobile</small></h3>
              <div class="line"></div>
        ...
        &lt;/div></code></pre>
              ...
              <h5><strong>Example</strong></h5>
              <a href="ajax.pie.jsp" data-bjax data-target="#bjax-target" class="btn btn-default">Load Me</a>
              <a href="blog.jsp" data-bjax data-target="#bjax-target" data-el="#content .row" class="btn btn-default">Load Page Element</a>
              <a href="index.jsp" data-bjax class="btn btn-default">Load Page</a>
              <div id="bjax-target" class="clearfix m-t m-b"></div>

              <pre><code class="html"><a href="blog.jsp" data-bjax data-target="#bjax-target" data-el="#content .row" class="btn btn-default">Load Page Element</a></code></pre>
        ...
        <script src="${scp}/js/ie/respond.min.js"></script>
        <script src="${scp}/js/ie/html5.js"></script>
        <script src="${scp}/js/ie/excanvas.js"></script>
        <![endif]--></code></pre>       
            </div>
          </section>
